...
import aImg0 from '../../images/about/image1.png'
import aImg1 from '../../images/about/image2.png'
                            ...
                            <div className="row">
                                <div className="col-lg-8">
                                    <div className="image_wrap">
                                        <img src={aImg0} alt="Techco - About " />
                                    </div>
                                </div>
                                <div className="col-lg-4">
                                    <div className="image_wrap position-relative">
                                        <img src={aImg1} alt="Techco - About" />
                            ...
                            <div className="row justify-content-lg-between">
                                <div className="col-lg-4">
                                    <div className="heading_focus_text">
                                        About
                                        <span className="badge bg-secondary text-white">Shree RevaTech 🙂</span>
                                    </div>
