...
import about1 from '../../../images/about/about6.png'
import aIcon1 from '../../../images/avatar/avatar-1.png'
import aIcon2 from '../../../images/avatar/avatar-2.png'
import aIcon3 from '../../../images/avatar/avatar-3.png'
          ...
          <div className="col-lg-5">
            <div className="about_content">
              <div className="heading_block mb-0 text-white">
                ...
                Shree Revatech <mark> Mission & Goal</mark>
                </h2>
                <p className="heading_description mb-0" align="justify">
                At Shree Revatech, our mission is to empower businesses by delivering innovative software solutions designed to streamline operations, fuel growth, and ensure success. With a strong focus on excellence and customer satisfaction, we are dedicated to achieving these goals.
                </p>
              </div>
            </div>
          </div>
