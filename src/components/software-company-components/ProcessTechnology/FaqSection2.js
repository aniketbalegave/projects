                    ...
                    <div className="col-lg-6">
                        <div className="heading_block">
                            ...
                            <h2 className="heading_text mb-0">
                                Our <mark> Digital Marketing Process</mark>
                            </h2>
                        </div>
                    ...
                    <div className="col-lg-5">
                        <Accordion open={open} toggle={toggle} className="accordion" id="service_process_faq">
                            <ul className="content_layer_group unordered_list_block text-center">
                                <li><AccordionHeader targetId="1"><span>Discovery & Research</span></AccordionHeader></li>
                                <li><AccordionHeader targetId="2"><span>Strategy Development</span></AccordionHeader></li>
                                <li><AccordionHeader targetId="3"><span>Execution & Campaign Launch</span></AccordionHeader></li>
                                <li><AccordionHeader targetId="4"><span>Monitoring & Optimization</span></AccordionHeader></li>
                                <li><AccordionHeader targetId="5"><span>Reporting & Analysis</span></AccordionHeader></li>
                            </ul>
                        </Accordion>
                    </div>
                </div>
