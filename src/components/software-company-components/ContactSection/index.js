                            ...
                            <ul className="contact_method_list unordered_list_block">
                                <li>
                                    <a href="tel:+8801680636189">
                                        ...
                                        <span className="text">+91 9284 0732 11</span>
                                    </a>
                                </li>
                                <li>
                                    <a href="mailto:Techco@gmail.com">
                                        ...
                                        <span className="text">info@shreerevatech.com</span>
                                    </a>
                                </li>
                                <li>
                                    <a href="#!">
                                        ...
                                        <span className="text">Office No 003, Near Lagad Transport, Nanaded City Pune 411041                                        </span>
                                    </a>
                                </li>
                            </ul>
