...
const FunFact = [
    {
        title: '5',
        subTitle: 'Years of experience Delivering innovative software solutions since 2018.',
        symbol: '+',
        icon: sIcon1,
    },
    {
                        ...
                        <div className="our_world_employees">
                            ...
                            <div className="content_wrap">
                                <h3 className="title_text mb-0">
                                    <b className="d-block">50+</b> Employees Across India
                                    A passionate and skilled team committed to delivering exceptional results nationwide.
                                </h3>
                            </div>
                        </div>
                    </div>
